...
const Contact = () => {
  ...
  const myLocation = [19.0380, 75.4100]; // Replace with your actual coordinates
    ...
    <section id="contact" className="py-20 bg-gray-100 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start space-y-8 lg:space-y-0 lg:space-x-8">
          ...
          >
            <h3 className="text-2xl font-bold mb-4 text-indigo-600 dark:text-indigo-400">Contact Information</h3>
            <p className="mb-4 text-gray-700 dark:text-gray-300">
              Feel free to reach out to me for any inquiries or opportunities.
            </p>
            <div className="flex items-center mb-2">
              <FaEnvelope className="mr-2 text-indigo-600 dark:text-indigo-400" />
              <a href="mailto:akashkolte240899@gmail.com" className="text-indigo-600 dark:text-indigo-400 hover:underline">
                akashkolte240899@gmail.com
              </a>
            </div>
            <div className="flex items-center mb-2">
              <FaGithub className="mr-2 text-indigo-600 dark:text-indigo-400" />
              <a href="https://github.com/KolteAkash" target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 hover:underline">
                github.com/KolteAkash
              </a>
            </div>
            <div className="flex items-center mb-8">
              <FaLinkedin className="mr-2 text-indigo-600 dark:text-indigo-400" />
              <a href="https://linkedin.com/in/akash-kolte-029382230" target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 hover:underline">
          ...
          >
            ...
            {submitMessage && (
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mt-4 p-4 bg-green-100 text-green-700 rounded-md">
                {submitMessage}
              </motion.div>
            )}
          </motion.div>
